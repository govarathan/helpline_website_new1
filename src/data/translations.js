export const translations = {
  en: {
    ...
    contact: { label: "Reach Out", title: "Get in Touch", desc: "Fill the form and our team will call you within 2 business hours.", namePH: "Your full name", phonePH: "10-digit mobile", loanType: "Loan Type", selectLoan: "Select loan type…", amountRange: "Amount Range", selectAmount: "Select range…", state: "State", selectState: "Select state…", notice: "By submitting, you consent to HelpLine Finance using your data. DPDP Act 2023 compliant.", submit: "Submit Enquiry →", office: "Contact Information", addr: "AKR Corniche Center No.30/11\nSecond Line Beach, George Town\nChennai – 600 001", hours: "Mon–Sat: 9:00 AM – 6:00 PM", waBtn: "💬 WhatsApp Us Now", toast: "✓ Enquiry submitted! We'll call you within 2 hours." },
  ...
  ta: {
    ...
    docs: {
      title: "வங்கி-NBFC ஆவண சரிபார்ப்பு பட்டியல்",
      subtitle: "சம்பளம் பெறுவோர், சுயதொழில் செய்பவர்கள் மற்றும் சொத்து சார்ந்த கடன்களுக்கான முழுமையான ஆவணத் தேவைகள்.",
      tabs: { sal: "சம்பளம் பெறுபவர்", self: "சுயதொழில்", prop: "சொத்து" },
      note: "ஆவணத் தேவைகள் கடன் வழங்குபவர் மற்றும் கடன் வகையைப் பொறுத்து மாறுபடலாம்.",
      cta: "தனிப்பயனாக்கப்பட்ட சரிபார்ப்பு பட்டியலைப் பெறுங்கள் →"
    },
    ...
    contact: { label: "தொடர்பு கொள்ளுங்கள்", title: "தொடர்பு கொள்ளுங்கள்", desc: "படிவத்தை நிரப்புங்கள், எங்கள் குழு 2 மணி நேரத்தில் அழைக்கும்.", namePH: "உங்கள் முழு பெயர்", phonePH: "10 இலக்க மொபைல்", loanType: "கடன் வகை", selectLoan: "கடன் வகையை தேர்ந்தெடுக்கவும்…", amountRange: "கடன் தொகை வரம்பு", selectAmount: "வரம்பை தேர்ந்தெடுக்கவும்…", state: "மாநிலம்", selectState: "மாநிலம் தேர்ந்தெடுக்கவும்…", notice: "உங்கள் தரவை பயன்படுத்த ஒப்புக்கொள்கிறீர்கள்.", submit: "விசாரணை சமர்ப்பி →", office: "தொடர்பு தகவல்", addr: "AKR Corniche Center No.30/11\nSecond Line Beach, George Town\nசென்னை – 600 001", hours: "திங்கள்–சனி: காலை 9:00 – மாலை 6:00", waBtn: "💬 WhatsApp செய்யுங்கள்", toast: "✓ விசாரணை சமர்ப்பிக்கப்பட்டது!" },
  ...
  hi: {
    ...
    docs: {
      title: "बैंक-NBFC दस्तावेज़ चेकलिस्ट",
      subtitle: "वेतनभोगी, स्व-नियोजित और संपत्ति-आधारित ऋणों के लिए पूर्ण दस्तावेज़ आवश्यकताएं।",
      tabs: { sal: "वेतनभोगी", self: "स्व-नियोजित", prop: "संपत्ति" },
      note: "दस्तावेज़ आवश्यकताएं ऋणदाता और ऋण प्रकार के आधार पर भिन्न हो सकती हैं।",
      cta: "व्यक्तिगत चेकलिस्ट प्राप्त करें →"
    },
    ...
    contact: { label: "संपर्क करें", title: "संपर्क करें", desc: "फ़ॉर्म भरें, हमारी टीम 2 घंटे में कॉल करेगी।", namePH: "आपका पूरा नाम", phonePH: "10 अंकों का मोबाइल", loanType: "ऋण प्रकार", selectLoan: "ऋण प्रकार चुनें…", amountRange: "ऋण राशि सीमा", selectAmount: "सीमा चुनें…", state: "राज्य", selectState: "राज्य चुनें…", notice: "अपना डेटा उपयोग करने की सहमति दें।", submit: "पूछताछ सबमिट करें →", office: "संपर्क जानकारी", addr: "AKR Corniche Center No.30/11\nSecond Line Beach, George Town\nचेन्नई – 600 001", hours: "सोमवार–शनिवार: सुबह 9:00 – शाम 6:00", waBtn: "💬 WhatsApp करें", toast: "✓ पूछताछ सबमिट हुई!" },
